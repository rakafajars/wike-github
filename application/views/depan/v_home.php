...
<head>
    ...
    <title>SMA Mekar Arum - Selamat Datang di SMA Mekar Arum</title>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img class="d-block" src="<?php echo base_url().'theme/images/sekolah.jpg'?>" alt="First slide">
                ...
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/sekolah.jpg'?>" alt="Second slide">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                ...
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/sekolah2.jpg'?>" alt="Third slide">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
...
<section class="clearfix about about-style2">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
               <h2>Welcome</h2>
               <p>Selamat Datang Di SMA Mekar Arum</p>

            </div>
            <div class="col-md-4">
                <img src="<?php echo base_url().'theme/images/sekolah2.jpg'?>" class="img-fluid about-img" alt="#">
            </div>
        </div>
    </div>
</section>
