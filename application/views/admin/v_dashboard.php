...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="http:/smamekararum.com">Yanyan Janwar</a>.</strong> All rights reserved.
  </footer>
...
<!-- Bootstrap 3.3.6 -->
<script src="<?php echo base_url().'assets/bootstrap/js/bootstrap.min.js'?>"></script>admin/login
<!-- FastClick -->
